...
/**
 * Sealed interface representing validation results. Following DOP principle: Make illegal states
 * unrepresentable. Can only be Success or Failure - no other states possible.
 */
