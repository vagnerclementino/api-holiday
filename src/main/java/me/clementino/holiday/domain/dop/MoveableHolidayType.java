...
/**
 * Enum representing different types of moveable holidays based on their calculation method. Based
 * on the OOP MoveableHolidayType but following DOP principles.
 *
 ...
 * Holiday.Moveable easter = new Holiday.Moveable("Easter Sunday", ..., LUNAR_BASED, ...);
 * Holiday.Moveable chineseNewYear = new Holiday.Moveable("Chinese New Year", ..., LUNAR_BASED, ...);
 *
 * // Relative holidays
 * Holiday.Moveable goodFriday = new Holiday.Moveable("Good Friday", ..., RELATIVE_TO_HOLIDAY, ...);
 * // Good Friday = Easter - 2 days
 *
 * // Weekday-based holidays
 * Holiday.Moveable laborDay = new Holiday.Moveable("Labor Day", ..., WEEKDAY_BASED, ...);
 ...
 * {@link HolidayOperations} class, maintaining separation between data classification and
 * operations.
 *
 * @author Vagner Clementino
 * @since 1.0
 * @see Holiday.Moveable
 * @see Holiday
 * @see HolidayOperations
 */
