...
/**
 * Sealed interface representing holiday status.
 * Following DOP v1.1 Principle 3: Make Illegal States Unrepresentable.
 * 
 * A holiday can only be in one of these states - no other combinations are possible.
 * This prevents bugs by making invalid states impossible to represent.
 */
