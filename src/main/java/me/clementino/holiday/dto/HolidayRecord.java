...
/**
 * Pure DOP record representing a holiday.
...
public record HolidayRecord(
     ...
     */
    public HolidayRecord(String name, LocalDate date, Location location, HolidayType type, 
                        boolean recurring, Optional<String> description) {
    ...
    public HolidayRecord withObserved(LocalDate observedDate) {
        return new HolidayRecord(id, name, date, Optional.ofNullable(observedDate), 
                                location, type, recurring, description);
    }
    ...
    public HolidayRecord withDescription(String newDescription) {
        return new HolidayRecord(id, name, date, observed, location, type, recurring, 
