...
public class GlobalExceptionHandler {
  ...
  /**
   * Immutable set of funny 404 error messages following DOP principles. Each
   * message includes
   * emojis and humor to make 404 errors less frustrating.
   */
  private static final Set<String> FUNNY_404_MESSAGES = Set.of(
  ...
  /**
   * Selects a random funny message from the immutable set. Uses ThreadLocalRandom
   * for better
